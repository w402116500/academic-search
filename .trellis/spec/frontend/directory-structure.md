...
| `frontend/src/features/auth/`, `frontend/src/features/research/`, `frontend/src/features/search/` | Domain UI, presentation helpers, CSS, and feature-specific composables |
...
Route-level Vue files use `*View.vue`; reusable Vue files use PascalCase;
feature helpers and Vue Query modules use kebab-case file names; composable
exports use a `use` prefix.
