"""SQLAlchemy and object-storage adapter for verified literature admission."""
...
from app.modules.literature.admission import (
    ...
    LiteratureAdmissionFulltext,
    LiteratureAdmissionFulltextDocument,
)
...
from app.modules.literature.contracts import CitationMetadata, CitationMetadataStatus
...
class SqlAlchemyLiteratureAdmissionAdapter:
    ...
    async def admit(
        ...
        *,
        ...
        # Read-side owner checks may share this request session. Admission owns a
        # fresh atomic transaction and must not inherit their implicit transaction.
    ...
    def _validate_admission_input(
        ...
        candidate: LiteratureAdmissionCandidate,
        fulltext_result: LiteratureAdmissionFulltext,
    ) -> tuple[CitationMetadata, LiteratureAdmissionFulltextDocument]:
        ...
        if fulltext_result.status != "available" or fulltext_result.document is None:
            raise CollectionAdmissionError(
